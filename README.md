...
> [!IMPORTANT]
> Репозиторий содержит ссылки на шаблоны и прототипы решений, предназначенные для упрощения и ускорения разработки.
> 
> Они не являются готовыми к использованию компонентами и предоставляются как основа для дальнейшей доработки под конкретные задачи.
> Простое копирование кода без анализа и интеграции в текущую разработку проекта может привести к неэффективным или некорректным решениям.
> 
> Поддержка шаблонов не осуществляется. 
...
- [Массовая обработка данных](https://github.com/STARKOV-Group/BulkProcessing) - репозиторий с шаблоном разработки для работы с большим количеством сущностей через объектную модель RX после миграций или для проведения массовой обработки
...
---
<img width="180" height="90" alt="ЦВД" src="https://github.com/user-attachments/assets/9a490aaf-12d3-480b-ba2f-a4745ee6ba58" />
