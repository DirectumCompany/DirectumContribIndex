...
- [Утилита экспорта данных из DIRECTUM 5](дополнительный механизм для Утилиты импорта данных)(https://github.com/DirectumCompany/d5-util-export-data) - репозиторий с механизмом экспорта исторических данных из Directum 5 в xlsx-документ.
